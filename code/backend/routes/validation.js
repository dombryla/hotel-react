...
module.exports = {
  validate: [
    ...
    check("login")
      ...
      .withMessage("Login must be at least 5 chars long."),
    check("password")
      .isLength({min: 1})
      .withMessage(
        "Password must be 5-16 characters and include a lower, upper case and a number."
      ),
    ...
    check("phoneNumber")
      ...
      .withMessage("Phone number consist 9 digits."),
    check("street")
      .isLength({min: 1, max: 30})
    ...
    check("pesel")
      ...
      .withMessage("PESEL consist of 11 digits."),
    check("salary")
      .isLength({min: 1, max: 8})
      .withMessage("You can not earn more then 10000000."),
    check("position")
      .matches(/^[A-Z].{1,}/)
      .withMessage("Choose a position."),
    check("startDate")
      .isLength({min: 10})
      .withMessage("This field is required."),
